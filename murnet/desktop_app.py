...
class MurnetApp(tk.Tk):
    ...
    def _request_password(self):
        ...
        from murnet.core.identity.keystore import EncryptedKeystore
    ...
    def _change_password(self):
        ...
        from murnet.core.identity.keystore import EncryptedKeystore, WrongPasswordError, WeakPasswordError
        ks = EncryptedKeystore(self.runner.data_dir)
        if not ks.exists():
