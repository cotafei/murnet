...
class MurnetCLI:
    ...
    async def _async_start(self, password: str):
        from murnet.core.node.async_node import AsyncMurnetNode
        from murnet.core.identity.keystore import WrongPasswordError
        try:
    ...
    async def _start_api(self):
        try:
            import uvicorn
            from murnet.api.server import create_app
    ...
    def cmd_publish(self, args):
        ...
        if not self.node: return
        from murnet.core.data.objects import MurObject
        from murnet.core.identity.identity import NodeIdentity
    ...
    def cmd_migrate(self, _args):
        from murnet.core.data.migrations import status as migration_status
        import sqlite3
    ...
    def _vpn_start(self, extra_args: list):
        ...
        from murnet.core.vpn.config import VPNConfig
        from murnet.core.vpn.tunnel import TunnelManager
        from murnet.core.vpn.socks5 import Socks5Server
    ...
    def run(self):
        from murnet.core.identity.keystore import prompt_password_cli
